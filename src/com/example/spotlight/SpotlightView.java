...
public class SpotlightView extends View {
	...
	//	canvas.drawCircle(getWidth()/2, getWidth()/2,mMaskScale,mPaint);
		canvas.drawBitmap(mMask, 0.0f, 0.0f, mPaint);
	}

	/**
	 *  view 渲染到视图tree时 移除系统的渲染
	 * @param callback
	 */
	...
	/**
	 * 将XML中设置的drawable 创建 BitmapShader
	 */
	...
	/**
	 * 此处相当于是为需要现实的View保持一个 大小相同的快照
	 * Bitmap.Config.ARGB_8888  颜色和alpha都有 质量最佳
	 * @param target
	 * @return
	 */
	...
	/**
	 * Bitmap.Config.ALPHA_8 类型的bitmap只有当一的alpha通道
